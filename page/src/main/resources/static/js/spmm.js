...
function showForm(val) {
    ...
    rootDiv.empty();
    var lhbDiv = $('<div>',{'style':'width:100%'});
    rootDiv.append(lhbDiv);
    ...
    var tdTxt4 =  $('<input>', {'type':'text','name':'txt4', 'id':'txt4',});
    td2.append(tdTxt3);
    td4.append(tdTxt4);
    td1.text("股票代码：");
    td3.text("股票名称：");
    ...
    var mmfx0 =  $('<input>', {'type':'radio','name':'mmfx', 'value':'0','style':'width:50px'});
    ...
    var btn1 =  $('<input>', {'type':'button','click':saveSpmm, 'id':'btn1','value':'保存','class':'l-button l-button-submit'});
    var btn2 =  $('<input>', {'type':'button','click':closeSpmm, 'id':'btn2','value':'关闭','class':'l-button l-button-reset'});
    btnDiv.append(btn1);
    btnDiv.append(btn2);
}
function saveSpmm() {
